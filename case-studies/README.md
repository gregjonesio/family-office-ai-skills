...
Worked, end-to-end examples of how the skills, blueprints, governance concepts, connector guidance, and review gates in this repository apply to realistic family office and RIA operating scenarios. Each case study walks one recurring workflow from the operating problem through the AI-assisted version, the human review gates, and what stays human.

> **Fictionalized and illustrative.** These case studies are sanitized, generalized examples written to show how the workflows fit together. They do **not** describe, represent, or disclose any actual family office, employer, client, principal, investment, vendor, counterparty, document, or operating environment. All scenarios, names, and figures are invented and directional. Nothing here is investment, legal, tax, accounting, compliance, insurance, or fiduciary advice, and using these materials creates no professional relationship.

---

## What these are

- **Applied examples.** They show the existing skills and blueprints used together on a concrete (fictional) operating situation, end to end.
- **Read-only and human-in-the-loop.** Every workflow produces drafts for a competent person to verify. Nothing here decides, transacts, approves, or sends.
- **A bridge between the skills and your office.** Read them after the [skills](../skills/) and [blueprints](../blueprints/) to see how the pieces compose into a real cadence.
...
*These case studies are illustrative operating patterns, not legal, compliance, investment, tax, insurance, or fiduciary advice, and not live integrations. Every output described is an unverified draft requiring human review.*
