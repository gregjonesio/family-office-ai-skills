...
Please confirm every item. These are requirements, not suggestions.

- [ ] **No confidential information** is included (no real families, principals, clients, employees, vendors, counterparties, or entities).
- [ ] **No client-specific or proprietary data** is included.
- [ ] **No live credentials, keys, tokens, endpoints, or account identifiers** are included.
...
<!-- Anything reviewers should pay particular attention to, especially advice-boundary or confidentiality considerations. -->
